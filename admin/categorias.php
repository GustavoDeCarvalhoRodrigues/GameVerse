...
<section class="hero"
  ...
  <h1
    ...
    Administração de Categorias</h1>
  <p style="font-size: 1.05rem; color: #e7e9ee; max-width: 600px; margin: 0 auto 10px auto;">Gerencie as categorias dos
    jogos cadastrados.</p>
</section>
  ...
  <div>
    <form method="post"
      ...
      <div style="display:flex;gap:10px;margin-top:10px;">
        <button class="btn" style="min-width:120px;"><?= $edit['idcategoria'] ? 'Salvar' : 'Criar' ?></button>
